                        ...
                        if (!string.IsNullOrEmpty(imdb))
                        {
                            ...
                            if (movieFileLoc?.Count() > 0)
                            {
                                ...
                                if (string.IsNullOrEmpty(fanArtLoc))
                                {
                                    ...
                                    if (string.IsNullOrEmpty(fanArtLoc))
                                    {
                                        fanArtLoc = Directory.GetFiles(moviePath)
                                                             .Where(file => Path.GetFileName(file).Contains("fanart", StringComparison.OrdinalIgnoreCase))
                                                             .FirstOrDefault();
                                    }
                                }
                                ...
                                if (string.IsNullOrEmpty(posterLoc))
                                {
                                    ...
                                    if (string.IsNullOrEmpty(posterLoc))
                                    {
                                        posterLoc = Directory.GetFiles(moviePath)
                                                             .Where(file => Path.GetFileName(file).Contains("poster", StringComparison.OrdinalIgnoreCase))
                                                             .FirstOrDefault();
                                    }
                                }
